...
//#define TFT_RST 8  //uncomment for ILI9340
#define TFT_DC 9
#define TFT_CS 10
...
void screenIntro()
{
	...
	tft.setTextArea(100, 100, 220, 140);
...
void screenLoading()
{
	...
	tft.setTextArea(100, 85, 220, 140);
	strcpy(textBuff, "Loading...");
	tft.printAligned(textBuff, gTextAlignTopCenter);
...
void screenSensors()
{
	...
	gTextArea t1 = { s1x, s1y, s1x + 2 * radius, s1y + 2 * radius };
	gTextArea t2 = { s2x, s2y, s2x + 2 * radius, s2y + 2 * radius };
	gTextArea t3 = { s3x, s3y, s3x + 2 * radius, s3y + 2 * radius };
