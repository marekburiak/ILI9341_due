...
#define LCD_CS 4 // Chip Select goes to Analog 3
#define LCD_DC 5 // Command/Data goes to Analog 2
...
// does not compile, dont know why yet
//  if ((bmpFile = SdFile.open(filename, O_READ)) == NULL) {
