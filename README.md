...
gText class from GLCD library was used as a base for rendering custom fonts. Currently only font rendering with solid background is supported. Custom font .h files can be generated with GLCDFontCreator2 tool:<br>
