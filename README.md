...
v0.91.001 - Performance improvements (especially fill circle), fixed a scanline fill bug, 
...
v0.90.025 - Added PushColors565 function, created BMP24toILI565 tool, updated sdFatTftBitmap example
